...
const sanitizeOptions = {
    ...
    allowedAttributes: {
        ...
        video: ['src', 'controls', 'width', 'height', 'autoplay', 'loop', 'muted', 'poster', 'playsinline', 'preload', 'style'],
        iframe: ['src', 'width', 'height', 'frameborder', 'allow', 'allowfullscreen', 'title', 'style', 'loading'],
        source: ['src', 'type'],
